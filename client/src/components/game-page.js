        ...
        return (
            <div>
                <Card>
                    ...
                    <CardBody>
                        {!playing && <WaitingRoom ws={ws} setPlaying={setPlaying} connectWebSocket={connectWebSocket} setWS={setWS}/>}
...
function WaitingRoom({ws, setPlaying, connectWebSocket, setWS}) {
